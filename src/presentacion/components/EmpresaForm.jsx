...
export default function EmpresaForm({ onSubmit, onChange, handleFileSelect, errors, backendError, form }) {
  return (
    <div
      ...
      <div className="absolute inset-0 bg-white/40 flex items-center justify-center">
        ...
        <div className="flex gap-6 bg-white/80 rounded-lg shadow-lg w-[900px]">
          <div className="w-full">
            <h1 className="text-center text-3xl font-extrabold text-gray-900 mt-4">Registro Empresa</h1>

            <form className="grid grid-cols-2 gap-x-8 gap-y-4  m-8 p-5" onSubmit={onSubmit}>
              {/* Columna izquierda */}
              <div className="flex flex-col gap-4">
                {[
                  { name: "nit", label: "NIT", placeholder: "Ingrese el NIT de la empresa", type: "text" },
                  { name: "nombre", label: "Empresa", placeholder: "Ingrese el nombre de la empresa", type: "text" },
                  { name: "direccion", label: "Dirección", placeholder: "Ingrese la dirección de la empresa", type: "text" },
                  { name: "telefono", label: "Teléfono", placeholder: "Ingrese el número de teléfono de contacto", type: "text" },
                  { name: "correo", label: "Correo", placeholder: "Ingrese el correo electrónico ", type: "email" },
                  { name: "password", label: "Contraseña", placeholder: "Cree una contraseña segura (mínimo 8 caracteres)", type: "password" },
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    value={form.nombres || ""}
                    className={`bg-white rounded-xl px-4 py-2.5 text-sm text-gray-500 placeholder-gray-400 outline-none 
                      ${errors?.["nombres"] ? "border border-red-500 bg-red-100" : "bg-gray-200 focus:ring-2 focus:ring-red-300 focus:bg-gray-50"}`}
                  />
                  {errors?.["nombres"] && (
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    onChange={onChange}
                    className={`bg-white rounded-xl px-4 py-2.5 text-sm text-gray-500 placeholder-gray-400 outline-none 
                      ${errors?.["apellidos"] ? "border border-red-500 bg-red-100" : "bg-gray-200 focus:ring-2 focus:ring-red-300 focus:bg-gray-50"}`}
                  />
                  {errors?.["apellidos"] && (
